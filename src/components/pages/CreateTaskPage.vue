<template>
  <div class="container">
    <div class="container__go-back-btn-and-title-flex">
      ...
      <span class="container__title">Create new task</span>
    </div>
    ...
    <button @click="createTask" class="container__create-task-btn">
      Create Task
    </button>
  </div>
</template>
  ...
  methods: {
    ...
    createTask() {
      ...
      if (
        (this.name !== "" &&
          this.description !== "" &&
          highLvlBtn.classList.contains(
            "container__priority-high-btn-active"
          )) ||
        (this.name !== "" &&
          this.description !== "" &&
          mediumLvlBtn.classList.contains(
            "container__priority-medium-btn-active"
          )) ||
        (this.name !== "" &&
          this.description !== "" &&
          lowLvlBtn.classList.contains("container__priority-low-btn-active"))
      ) {
        if (
          highLvlBtn.classList.contains("container__priority-high-btn-active")
        ) {
          this.addTaskAction({
            name: this.name,
        ...
        iziToast.warning({
          title: "Warning",
          message: "Please choose lvl of the task.",
        });
      }
    },
  },
